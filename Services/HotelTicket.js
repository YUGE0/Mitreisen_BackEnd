...
async function sendHotelEmail(book,uname,fname,desFrom,desTo,traveler,departure,arrival,cla,service,trip,price,date,dateFrom,dateTo,about,place,uemail) {
  const mailOptions = {
    ...
    <h3>Hotel Name : ${fname}</h3>
    <h3>Check In  : ${dateFrom}</h3>
    <h3>Check Out : ${dateTo}</h3>
