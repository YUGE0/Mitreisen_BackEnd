...
async function sendFlightEmail(book,uname,fname,desFrom,desTo,traveler,departure,arrival,cla,service,trip,price,date,dateFrom,dateTo,about,place,uemail) {
  const mailOptions = {
